...
export function MainRoof() {
    ...
    return (
        <>
            <FrontPage title="Minor Roof Repair and Leak Solutions in South Florida"
                subtitle="A Small Roof Problem Shouldn’t Become Major Damage" 
                desc="A ceiling stain or minor leak does not always mean you need a new roof. The source may be a localized issue
                    ...
                    authorized scope." 
                subDesc="We address limited, localized repairs — not full roof replacements or major roofing projects."
            ...
            <section className="sec-service-desc">
                ...
                <ul>
                    ...
                    <p>Not necessarily. Water may enter through the roof, flashing, a penetration, an exterior wall, a window, or
                        ...
                        recommending a repair.</p>
                    <li>Do you provide complete roof replacements?</li>
                    <p>No. FB StormX provides only limited minor repairs that fall within our authorized scope.
                        Full replacements, major repairs, and work requiring a roofing contractor license or permit must be handled
                        by an appropriately licensed contractor.</p>
                    <li>How quickly can you come?</li>
                    <p>Response time depends on your location, weather conditions, and current availability. Contact us to request
                        the earliest available appointment.</p>
                    <li>Looking for Minor Roof Leak Repair in South Florida?</li>
                    <p>Send us your ZIP code and a photo or short video through WhatsApp for a quick, free initial evaluation.
                        Service is subject to inspection and confirmation that the work falls within our authorized scope.</p>
                </ul>
