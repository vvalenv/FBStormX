            ...
            <section className="sec-service-desc">
                <div className="div-data-services" id="div-data-window">
                    <div className="elem-data-service">
                        ...
                        <ul>
                            <li className="li-data-service">It's hard to open, or it needs two hands to close.</li>
                            <li className="li-data-service">Water appears on the sill or the floor after heavy rain.</li>
                            <li className="li-data-service">You can feel air coming in with the window fully closed.</li>
                            <li className="li-data-service">The lock no longer lines up the way it used to.</li>
                            <li className="li-data-service">The track is full of sand, dirt or debris.</li>
                        </ul>
                    </div>
                    <div className="elem-data-service">
                        <h2>We repair first, and replace only if you really need it</h2>
                        <p className="p-data-service">Most windows don't need to be replaced. In many South Florida homes the real problem is a worn roller, a dirty track or a failed seal, and all of those can be corrected in a single visit. We evaluate the window first and tell you honestly what it needs, even when the answer is that it needs very little.</p>
                    </div>
                    <div className="elem-data-service">
                        <h2>More done in one visit</h2>
                        <p className="p-data-service">While we're at your home, we can take care of other repairs on your list too, from sliding glass doors to caulking around the frames. One visit, multiple repairs, problem solved.</p>
                    </div>
                </div>
                <h2 className="h2-FAQ">Frequently Asked Questions</h2>
                <article className="art-FAQ">
                    <Acordion title={<><FontAwesomeIcon icon={faClock} className="accordion-icon"/> How long does a window repair take?</>} 
                        content="Many common window repairs and adjustments can be completed during a single visit. The actual time
                            depends on the condition of the window and the parts or repairs required."/>
                    <Acordion title={<><FontAwesomeIcon icon={faDroplet} className="accordion-icon"/> My window leaks when it rains. Is the window or the exterior sealing causing the problem?</>} 
                    ...
                    <Acordion title={<><FontAwesomeIcon icon={faLocationDot} className="accordion-icon"/> Do you provide window repair services in my area?</>} 
                    ...
                    <Acordion title={<><FontAwesomeIcon icon={faCircleQuestion} className="accordion-icon"/> Not Sure What Your Window Needs?</>} 
